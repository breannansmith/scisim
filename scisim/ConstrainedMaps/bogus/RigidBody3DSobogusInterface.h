...
#ifndef RIGID_BODIES_3D_SOBOGUS_INTERFACE_H
#define RIGID_BODIES_3D_SOBOGUS_INTERFACE_H
...
class RigidBodies3DSobogusInterface final
{

public:

  RigidBodies3DSobogusInterface();
  ~RigidBodies3DSobogusInterface();
