...
// TODO: Don't need to explicitly form E in this code
// TODO: Move to unsigned where possible

class LinearMDPOperatorIpopt final : public FrictionOperator
{
...
public:
  ...
  virtual void flow( const scalar& t, const SparseMatrixsc& Minv, const VectorXs& v0, const SparseMatrixsc& D, const SparseMatrixsc& Q, const VectorXs& gdotD, const VectorXs& mu, const VectorXs& lambda, VectorXs& beta, VectorXs& alpha ) override;
...
#ifdef IPOPT_FOUND
class LinearMDPNLP final : public Ipopt::TNLP
{

public:

  LinearMDPNLP( const SparseMatrixsc& Q, VectorXs& beta );

  virtual ~LinearMDPNLP() override;
  ...
  inline const SparseMatrixsc& E() const
  {
    return m_E;
  }

  inline SparseMatrixsc& E()
  {
    return m_E;
  }
...
private:
  ...
  LinearMDPNLP( const LinearMDPNLP& );
  LinearMDPNLP& operator=( const LinearMDPNLP& );
